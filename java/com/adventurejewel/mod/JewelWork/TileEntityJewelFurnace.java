...
public class TileEntityJewelFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.jewel_furnace";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				JewelWorkBlock.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = JewelFurnaceRecipes.getInstance().getJewelResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = JewelFurnaceRecipes.getInstance().getJewelResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	{
		return "adventurejewel:jewel_furnace";
	}
